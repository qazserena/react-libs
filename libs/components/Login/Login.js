...
import { defaultExceptionHandler, getApiToken } from '../../index';
...
var Login = function (props) {
    var _a = useState(true), spinning = _a[0], setSpinning = _a[1];
    ...
    var onFinish = function (values) { return __awaiter(void 0, void 0, void 0, function () {
        ...
        return __generator(this, function (_a) {
            switch (_a.label) {
                case 0:
                    _a.trys.push([0, 2, , 3]);
                    return [4 /*yield*/, authContext.loginWithAccount(values.username, values.password, values.remember)];
                case 1:
                    user = _a.sent();
    ...
    useEffect(function () {
        ...
        setSpinning(false);
        if (token) {
            var hide_1 = message.loading('自动登录中...');
            setSpinning(true);
            authContext
                .loginWithToken()
                .then(function (user) {
    ...
    return (React.createElement(Spin, { spinning: spinning, delay: 100 },
