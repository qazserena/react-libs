...
export var MetaEnumEditor = function () {
    var metaRestApi = new RESTfulApi(metaApi.data.enumRest, 'code');
    var columns = [
        {
            dataIndex: 'code',
            title: '枚举代码',
            editable: function (_, record) {
                ...
                return [
                    ...
                    React.createElement(Popconfirm, { key: "delete", title: "\u786E\u8BA4\u5220\u9664\u8BE5\u6761\u6570\u636E\u5417?", okText: "\u786E\u8BA4", cancelText: "\u53D6\u6D88", onConfirm: function () { return __awaiter(void 0, void 0, void 0, function () {
                            return __generator(this, function (_a) {
                                switch (_a.label) {
                                    case 0: return [4 /*yield*/, metaRestApi.delete(record.code)];
                                    case 1:
                                        _a.sent();
    ...
    var request = function (_params, _sort, _filter) { return __awaiter(void 0, void 0, void 0, function () {
        ...
        return __generator(this, function (_a) {
            switch (_a.label) {
                case 0: return [4 /*yield*/, metaRestApi.list()];
                case 1:
                    rows = _a.sent();
                    return [2 /*return*/, {
        ...
        return __generator(this, function (_a) {
            switch (_a.label) {
                case 0:
                    ...
                    return [4 /*yield*/, metaRestApi.create({ code: data.code, label: data.label })];
                case 1:
                    _a.sent();
                    data.newRow = false;
                    return [3 /*break*/, 4];
                case 2: return [4 /*yield*/, metaRestApi.update({ code: data.code, label: data.label })];
                case 3:
                    _a.sent();
                    _a.label = 4;
        ...
        return __generator(this, function (_a) {
            switch (_a.label) {
                case 0:
                    ...
                    return [4 /*yield*/, metaRestApi.delete(row.code)];
                case 1:
                    _a.sent();
                    _a.label = 2;
    ...
    return (React.createElement(EditableProTable, { rowKey: "id", columns: columns, expandable: {
            expandedRowRender: function (record) { return React.createElement(MetaEnumItemExpandEditor, { row: record }); },
        }, request: request, recordCreatorProps: {
